...
-- Date        : Fri May  3 17:18:16 2024
-- Host        : localhost.localdomain running 64-bit unknown
-- Command     : write_vhdl -force -mode funcsim
--               /home/dcs/git/mopshub_readout/Vivado/mopshub_readout/mopshub_readout/mopshub_readout.gen/sources_1/bd/mopshub_readout_bd/ip/mopshub_readout_bd_clk_wiz_1_0/mopshub_readout_bd_clk_wiz_1_0_sim_netlist.vhdl
...
entity mopshub_readout_bd_clk_wiz_1_0_mopshub_readout_bd_clk_wiz_1_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of mopshub_readout_bd_clk_wiz_1_0_mopshub_readout_bd_clk_wiz_1_0_clk_wiz : entity is "mopshub_readout_bd_clk_wiz_1_0_clk_wiz";
end mopshub_readout_bd_clk_wiz_1_0_mopshub_readout_bd_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of mopshub_readout_bd_clk_wiz_1_0_mopshub_readout_bd_clk_wiz_1_0_clk_wiz is
  signal clk_40_mopshub_readout_bd_clk_wiz_1_0 : STD_LOGIC;
  signal clk_in1_mopshub_readout_bd_clk_wiz_1_0 : STD_LOGIC;
  signal clk_uart_mopshub_readout_bd_clk_wiz_1_0 : STD_LOGIC;
  signal clkfbout_buf_mopshub_readout_bd_clk_wiz_1_0 : STD_LOGIC;
  signal clkfbout_mopshub_readout_bd_clk_wiz_1_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_mopshub_readout_bd_clk_wiz_1_0,
      O => clkfbout_buf_mopshub_readout_bd_clk_wiz_1_0
    );
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_mopshub_readout_bd_clk_wiz_1_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_uart_mopshub_readout_bd_clk_wiz_1_0,
      O => clk_uart
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_40_mopshub_readout_bd_clk_wiz_1_0,
      O => clk_40
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CDDCREQ => '0',
      CLKFBIN => clkfbout_buf_mopshub_readout_bd_clk_wiz_1_0,
      CLKFBOUT => clkfbout_mopshub_readout_bd_clk_wiz_1_0,
      CLKFBOUTB => NLW_mmcme4_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcme4_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_mopshub_readout_bd_clk_wiz_1_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_uart_mopshub_readout_bd_clk_wiz_1_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_40_mopshub_readout_bd_clk_wiz_1_0,
...
entity mopshub_readout_bd_clk_wiz_1_0 is
  ...
  attribute NotValidForBitStream of mopshub_readout_bd_clk_wiz_1_0 : entity is true;
end mopshub_readout_bd_clk_wiz_1_0;

architecture STRUCTURE of mopshub_readout_bd_clk_wiz_1_0 is
begin
inst: entity work.mopshub_readout_bd_clk_wiz_1_0_mopshub_readout_bd_clk_wiz_1_0_clk_wiz
     port map (
      clk_40 => clk_40,
      clk_in1 => clk_in1,
      clk_uart => clk_uart,
