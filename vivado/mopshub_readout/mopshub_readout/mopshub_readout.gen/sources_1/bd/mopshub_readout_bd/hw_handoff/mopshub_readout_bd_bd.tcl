...
################################################################
# This is a generated script based on design: mopshub_readout_bd
#
...
# source mopshub_readout_bd_script.tcl
...
set design_name mopshub_readout_bd
...
proc create_root_design { parentCell } {
  ...
  set gtrefclk_in_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 gtrefclk_in_0 ]
  ...
  set dbg_elink_0 [ create_bd_port -dir I dbg_elink_0 ]
  set dip_sw_0 [ create_bd_port -dir I -from 3 -to 0 dip_sw_0 ]
  ...
  set irq_elink_dbg_0 [ create_bd_port -dir O irq_elink_dbg_0 ]
  ...
  set sfp_enable_0 [ create_bd_port -dir O sfp_enable_0 ]
  set sysclk_n_0 [ create_bd_port -dir I sysclk_n_0 ]
  set sysclk_p_0 [ create_bd_port -dir I sysclk_p_0 ]
  set tx_data_rdy_0 [ create_bd_port -dir O tx_data_rdy_0 ]
  set tx_elink_n_0 [ create_bd_port -dir O tx_elink_n_0 ]
  set tx_elink_p_0 [ create_bd_port -dir O tx_elink_p_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {195.690} \
   CONFIG.CLKOUT1_PHASE_ERROR {92.039} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {11.53846} \
   CONFIG.CLKOUT2_DRIVES {Buffer} \
   CONFIG.CLKOUT2_JITTER {143.874} \
   CONFIG.CLKOUT2_PHASE_ERROR {92.039} \
   ...
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {104.000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.DrpClkRate {31.25} \
   CONFIG.GT_Location {X1Y14} \
  ...
  # Create instance: mopshub_readout_0, and set properties
  set block_name mopshub_readout
  set block_cell_name mopshub_readout_0
  if { [catch {set mopshub_readout_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mopshub_readout_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net gig_ethernet_pcs_pma_0_sfp [get_bd_intf_ports sfp_0] [get_bd_intf_pins gig_ethernet_pcs_pma_0/sfp]
  connect_bd_intf_net -intf_net gtrefclk_in_0_1 [get_bd_intf_ports gtrefclk_in_0] [get_bd_intf_pins gig_ethernet_pcs_pma_0/gtrefclk_in]
  connect_bd_intf_net -intf_net user_si570_sysclk_1 [get_bd_intf_ports clk_sys] [get_bd_intf_pins clk_wiz_0/CLK_IN1_D]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_elink [get_bd_pins clk_wiz_0/clk_elink] [get_bd_pins mopshub_readout_0/clk_elink]
  connect_bd_net -net clk_wiz_0_clk_m [get_bd_pins clk_wiz_0/clk_m] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins mopshub_readout_0/clk_m]
  connect_bd_net -net clk_wiz_0_clk_rx [get_bd_pins clk_wiz_0/clk_rx] [get_bd_pins mopshub_readout_0/clk_rx]
  connect_bd_net -net clk_wiz_0_clk_tx [get_bd_pins clk_wiz_0/clk_tx] [get_bd_pins mopshub_readout_0/clk_tx]
  connect_bd_net -net clk_wiz_1_clk_40 [get_bd_pins clk_wiz_1/clk_40] [get_bd_pins ila_0/clk] [get_bd_pins mopshub_readout_0/clk_40] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_clk_uart [get_bd_pins clk_wiz_1/clk_uart] [get_bd_pins mopshub_readout_0/clk_uart]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins mopshub_readout_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net dbg_elink_0_1 [get_bd_ports dbg_elink_0] [get_bd_pins mopshub_readout_0/dbg_elink]
  connect_bd_net -net dip_sw_0_1 [get_bd_ports dip_sw_0] [get_bd_pins mopshub_readout_0/dip_sw]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rx_dv [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rx_dv] [get_bd_pins mopshub_readout_0/gmii_rx_dv]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rx_er [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rx_er] [get_bd_pins mopshub_readout_0/gmii_rx_er]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rxd [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rxd] [get_bd_pins mopshub_readout_0/gmii_rxd]
  connect_bd_net -net gig_ethernet_pcs_pma_0_mmcm_locked_out [get_bd_pins gig_ethernet_pcs_pma_0/mmcm_locked_out] [get_bd_pins mopshub_readout_0/mmcm_locked]
  connect_bd_net -net gig_ethernet_pcs_pma_0_resetdone [get_bd_pins gig_ethernet_pcs_pma_0/resetdone] [get_bd_pins mopshub_readout_0/resetdone]
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out] [get_bd_pins mopshub_readout_0/clk125]
  connect_bd_net -net in_rx_serial_0_1 [get_bd_ports in_rx_serial_0] [get_bd_pins mopshub_readout_0/in_rx_serial]
  connect_bd_net -net mopshub_readout_0_clk_ipb [get_bd_pins gig_ethernet_pcs_pma_0/independent_clock_bufg] [get_bd_pins mopshub_readout_0/clk_ipb]
  connect_bd_net -net mopshub_readout_0_clk_out_n [get_bd_ports clk_out_n_0] [get_bd_pins mopshub_readout_0/clk_out_n]
  connect_bd_net -net mopshub_readout_0_clk_out_p [get_bd_ports clk_out_p_0] [get_bd_pins mopshub_readout_0/clk_out_p]
  connect_bd_net -net mopshub_readout_0_configuration_vector [get_bd_pins gig_ethernet_pcs_pma_0/configuration_vector] [get_bd_pins mopshub_readout_0/configuration_vector]
  connect_bd_net -net mopshub_readout_0_counter_code_err [get_bd_pins ila_0/probe2] [get_bd_pins mopshub_readout_0/counter_code_err]
  connect_bd_net -net mopshub_readout_0_counter_dec10b_in_rdy [get_bd_pins ila_0/probe4] [get_bd_pins mopshub_readout_0/counter_dec10b_in_rdy]
  connect_bd_net -net mopshub_readout_0_counter_disp_err [get_bd_pins ila_0/probe1] [get_bd_pins mopshub_readout_0/counter_disp_err]
  connect_bd_net -net mopshub_readout_0_counter_rst_mopshub [get_bd_pins ila_0/probe0] [get_bd_pins mopshub_readout_0/counter_rst_mopshub]
  connect_bd_net -net mopshub_readout_0_dec10b_in_dbg_uart [get_bd_pins ila_0/probe3] [get_bd_pins mopshub_readout_0/dec10b_in_dbg_uart]
  connect_bd_net -net mopshub_readout_0_gmii_tx_en [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_en] [get_bd_pins mopshub_readout_0/gmii_tx_en]
  connect_bd_net -net mopshub_readout_0_gmii_tx_er [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_er] [get_bd_pins mopshub_readout_0/gmii_tx_er]
  connect_bd_net -net mopshub_readout_0_gmii_txd [get_bd_pins gig_ethernet_pcs_pma_0/gmii_txd] [get_bd_pins mopshub_readout_0/gmii_txd]
  connect_bd_net -net mopshub_readout_0_irq_can_rec [get_bd_ports irq_can_rec_0] [get_bd_pins mopshub_readout_0/irq_can_rec]
  connect_bd_net -net mopshub_readout_0_irq_can_tra [get_bd_ports irq_can_tra_0] [get_bd_pins mopshub_readout_0/irq_can_tra]
  connect_bd_net -net mopshub_readout_0_irq_elink_dbg [get_bd_ports irq_elink_dbg_0] [get_bd_pins mopshub_readout_0/irq_elink_dbg]
  connect_bd_net -net mopshub_readout_0_irq_elink_rec [get_bd_ports irq_elink_rec_0] [get_bd_pins mopshub_readout_0/irq_elink_rec]
  connect_bd_net -net mopshub_readout_0_irq_elink_tra [get_bd_ports irq_elink_tra_0] [get_bd_pins mopshub_readout_0/irq_elink_tra]
  connect_bd_net -net mopshub_readout_0_led [get_bd_ports led_0] [get_bd_pins mopshub_readout_0/led]
  connect_bd_net -net mopshub_readout_0_out_tx_serial [get_bd_ports out_tx_serial_0] [get_bd_pins mopshub_readout_0/out_tx_serial]
  connect_bd_net -net mopshub_readout_0_rst_eth [get_bd_pins gig_ethernet_pcs_pma_0/reset] [get_bd_pins mopshub_readout_0/rst_eth]
  connect_bd_net -net mopshub_readout_0_rx_data_rdy [get_bd_ports rx_data_rdy_0] [get_bd_pins mopshub_readout_0/rx_data_rdy]
  connect_bd_net -net mopshub_readout_0_sfp_enable [get_bd_ports sfp_enable_0] [get_bd_pins mopshub_readout_0/sfp_enable]
  connect_bd_net -net mopshub_readout_0_tx_data_rdy [get_bd_ports tx_data_rdy_0] [get_bd_pins mopshub_readout_0/tx_data_rdy]
  connect_bd_net -net mopshub_readout_0_tx_elink_n [get_bd_ports tx_elink_n_0] [get_bd_pins mopshub_readout_0/tx_elink_n]
  connect_bd_net -net mopshub_readout_0_tx_elink_p [get_bd_ports tx_elink_p_0] [get_bd_pins mopshub_readout_0/tx_elink_p]
  connect_bd_net -net proc_sys_reset_0_mb_reset [get_bd_pins mopshub_readout_0/reset] [get_bd_pins proc_sys_reset_0/mb_reset]
  connect_bd_net -net rx_elink_n_0_1 [get_bd_ports rx_elink_n_0] [get_bd_pins mopshub_readout_0/rx_elink_n]
  connect_bd_net -net rx_elink_p_0_1 [get_bd_ports rx_elink_p_0] [get_bd_pins mopshub_readout_0/rx_elink_p]
  connect_bd_net -net sysclk_n_0_1 [get_bd_ports sysclk_n_0] [get_bd_pins mopshub_readout_0/sysclk_n]
  connect_bd_net -net sysclk_p_0_1 [get_bd_ports sysclk_p_0] [get_bd_pins mopshub_readout_0/sysclk_p]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins mopshub_readout_0/mopshub_id] [get_bd_pins xlconstant_0/dout]
  ...
  set_property PFM.CLOCK {pl_clk0 {id "4" is_default "false" proc_sys_reset "" status "fixed"}} [get_bd_cells /zynq_ultra_ps_e_0]
